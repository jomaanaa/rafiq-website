...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $shift_preference = trim((string)($_POST['shift_preference'] ?? ''));
    ...
    if ($first_name === '' || $last_name === '' || $email === '' || $phone === '' || $address === '' || $gender === '') {
        ...
        $error = "Please select your shift preference.";
    }  else {
        try {
            ...
            if (!empty($_FILES['photo']['name']) && is_uploaded_file($_FILES['photo']['tmp_name'])) {
                ...
                $fileName = 'caregiver_' . $provider_id . '_' . time() . '.' . $ext;
            ...
            if (!empty($_FILES['cv']['name']) && is_uploaded_file($_FILES['cv']['tmp_name'])) {
                ...
                $cvFileName = 'cv_caregiver_' . $provider_id . '_' . time() . '.' . $cvExt;
            ...
            $updateCaregiver = $pdo->prepare("
                UPDATE caregiver
                SET shift_preference = :shift_preference
                WHERE user_id = :id
            ");
            $updateCaregiver->execute([
        ...
        <div class="profile-hero">
            <div class="hero-content">
                ...
                <div>
                    ...
                    <p class="profile-sub"><?= h($fullName ?: 'Caregiver Profile') ?></p>
                </div>
            </div>
        </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-grid">
                    ...
                    <div class="form-box">
                        ...
                        <?php $shift = (string)($data['shift_preference'] ?? ''); ?>
                        <select id="shift_preference" name="shift_preference" required>
                            ...
                            <option value="Flexible" <?= $shift === 'Flexible' ? 'selected' : '' ?>>Flexible</option>
                        </select>
                    </div>
                    <div class="form-box">
                ...
                <div class="actions">
                    <a class="btn cancel" href="caregiver_profile.php">Cancel</a>
