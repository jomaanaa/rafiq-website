    ...
    <section class="profile-card">
        <div class="profile-hero">
            <div class="hero-content">
                ...
                <div>
                    <h1 class="profile-title"><?= h($fullName ?: 'Doctor Profile') ?></h1>
        ...
        <div class="profile-body">
            <div class="info-grid">
                ...
                <div class="info-box"><p class="label">Speciality</p><p class="value"><?= h($data['speciality'] ?? '-') ?></p></div>
                <div class="info-box">
                    <p class="label">Medical License</p>
                    <p class="value">
                        <?php if (!empty($data['medical_license'])): ?>
                            <a href="../../uploads/<?= h(basename($data['medical_license'])) ?>" target="_blank" rel="noopener">View medical license</a>
                        <?php else: ?>
                            No medical license uploaded
                        <?php endif; ?>
                    </p>
                </div>
            ...
            <div class="actions">
                <a class="btn edit" href="doctor_profile_edit.php">Edit Profile</a>
