    ...
    <section class="profile-card">
        <div class="profile-hero">
            <div class="hero-content">
                ...
                <div>
                    <h1 class="profile-title"><?= h($fullName ?: 'Driver Profile') ?></h1>
        ...
        <div class="profile-body">
                ...
                <div class="info-box">
                    ...
                    <p class="value">
                        <?php if (!empty($data['driving_license'])): ?>
                            <a href="../../uploads/<?= h(basename($data['driving_license'])) ?>" target="_blank" rel="noopener">View driving license</a>
                        <?php else: ?>
            ...
            <div class="actions">
                <a class="btn edit" href="driver_profile_edit.php">Edit Profile</a>
