...
.btn.edit:hover{
    box-shadow:0 18px 36px rgba(64,64,102,.26);
}
    ...
    <section class="profile-card">
        <div class="profile-hero">
            <div class="hero-content">
                ...
                <div>
                    <h1 class="profile-title"><?= h($fullName ?: 'Interpreter Profile') ?></h1>
        ...
        <div class="profile-body">
            <div class="info-grid">
                ...
                <div class="info-box">
                    ...
                    <p class="value"><?= h($data['languages'] ?? '-') ?></p>
                </div>

                <div class="info-box">
                    <p class="label">National ID</p>
                    <p class="value"><?= h($data['national_id'] ?? '-') ?></p>
                </div>
            ...
            <div class="actions">
                <a class="btn edit" href="int_profile_edit.php">Edit Profile</a>
